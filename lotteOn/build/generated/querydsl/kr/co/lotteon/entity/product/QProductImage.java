...
public class QProductImage extends EntityPathBase<ProductImage> {
    ...
    private static final long serialVersionUID = 166116846L;
    ...
    public final StringPath oNameDetail = createString("oNameDetail");

    public final StringPath oNameList = createString("oNameList");

    public final StringPath oNameMain = createString("oNameMain");

    public final StringPath oNameThumb3 = createString("oNameThumb3");

    public final QProduct product;

    public final DateTimePath<java.time.LocalDateTime> rdate = createDateTime("rdate", java.time.LocalDateTime.class);

    public final StringPath sNameDetail = createString("sNameDetail");

    public final StringPath sNameList = createString("sNameList");

    public final StringPath sNameMain = createString("sNameMain");

    public final StringPath sNameThumb3 = createString("sNameThumb3");
